...
<head>
<title>Registrácia pre pacienta</title>
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<meta charset="utf-8">
<link rel="stylesheet" type="text/css" href="css/loginregisterpacient.css">
...
<form class="loginbox" action="{{ route('register') }}" method="POST">
    ...
    <div class="loginbox_logo-container">
        <a href="index" target="blank">
            <img class="loginbox_logo" src="img/logo5.png" alt="logo">
        </a>
    </div>
    <div class="loginbox_content">
        <div class="loginbox_header">Registrácia pre pacienta</div>
            <input class="loginbox_input" type="number" name="name" placeholder="Zadaj Rodné číslo bez lomítka" required>
            ...
            <div class="loginbox_links">
                <a href="loginpacient" class="loginbox_link">Máš účet a chceš sa prihlásiť?</a>
            </div>
    </div>
</form>
